...
df = pd.read_excel('teacher10_2nd_rot.xlsx')
#print (df)
df1 = pd.read_excel('teacher10_2nd_pos.xlsx')
#print(df1)
# df2 = pd.read_excel('capoeira800framesmodifiedv3_rot.xlsx')
df2 = pd.read_excel('student2ndparterrormodified1_rot.xlsx')
df3 = pd.read_excel('student2ndparterrormodified1_pos.xlsx')
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                ...
                                url = "static/student2ndpartmajorerrorV5.mp4",
                                controls = False,
                                width = '330%',
                                height = '430%'  
                            ),
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                ...
                                url = "static/teacher2ndpartmajorerrorV5.mp4",
                                controls = False,
                                width = '330%',
                                height = '430%'  
                            ),
